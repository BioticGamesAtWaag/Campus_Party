...
In this design we use the Arduino Uno microcontroller. These are abundantly available on the web, for example at [Bens Electronics](https://benselectronics.nl/arduino-leonardo/)(12.00)
